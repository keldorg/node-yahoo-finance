...
var _FTSE100 = require('./symbols/symbolsFTSE100');
var _SP500 = require('./symbols/symbolsSP500');
var _STOXX50 = require('./symbols/symbolsSTOXX50');

var _markets = [];
_markets['FTSE100'] = _FTSE100.symbols;
_markets['SP500'] = _SP500.symbols;
_markets['STOXX50'] = _STOXX50.symbols;
...
function symbols(market, cb) {
  return Promise.resolve()
    ...
    .catch(function (err) {
      throw new Error(util.format('Failed to find market (%s)', market));
    })
    .nodeify(cb);
}
